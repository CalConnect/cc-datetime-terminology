...
This document is amongst a series of International Standards dealing with date and time by Technical Committee ISO/TC {technical-committee-number}, _{technical-committee}_, WG {workgroup-number} _{workgroup}_.
